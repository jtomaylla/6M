<%@ Page Title="" Language="C#" MasterPageFile="~/GanttMaster.Master" AutoEventWireup="true"
    CodeBehind="DocumentExplorer.aspx.cs" Inherits="SISMONUi._6M.DocumentExplorer1" %>
                ...
                <telerik:RadAjaxPanel ID="rapTask" runat="server">
                    ...
                    <div class="conten_caja_sub_categoria marhin-topnone" style="width: 940px;">
                        ...
                        <div class="tabla_sup_caja_sub_categoria" style="min-height: 350px;">
                            ...
                            <asp:Panel ID="pnProject" runat="server" ScrollBars="Auto">
                                <telerik:RadTreeMap ID="rtmProject" runat="server" Style="" Width="1015px" Height="600px"
                                    AlgorithmType="Horizontal" Skin="Windows7" DataFieldID="ID" DataFieldParentID="ParentID"
                                    DataTextField="Text" DataValueField="Value" DataKeyNames="DivID,DivClass" OnItemDataBound="rtmProject_ItemDataBound"
                                    ResolvedRenderMode="Classic">
                                    <ClientItemTemplate>
