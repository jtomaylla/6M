...
<head runat="server">
    ...
    <!--#endif-->
    <link href="pdf.js/viewer.css" rel="stylesheet" type="text/css" />
    <!--#if !(FIREFOX || MOZCENTRAL || CHROME)-->
    <script type="text/javascript" src="pdf.js/compatibility.js"> </script>
    <!--#endif-->
    <script type="text/javascript" src="pdf.js/l10n.js"> </script>
    <script type="text/javascript" src="pdf.js/core.js"> </script>
    <script type="text/javascript" src="pdf.js/util.js"> </script>
    <script type="text/javascript" src="pdf.js/api.js"> </script>
    <script type="text/javascript" src="pdf.js/metadata.js"> </script>
    <script type="text/javascript" src="pdf.js/canvas.js"> </script>
    <script type="text/javascript" src="pdf.js/obj.js"> </script>
    <script type="text/javascript" src="pdf.js/function.js"> </script>
    <script type="text/javascript" src="pdf.js/charsets.js"> </script>
    <script type="text/javascript" src="pdf.js/cidmaps.js"> </script>
    <script type="text/javascript" src="pdf.js/colorspace.js"> </script>
    <script type="text/javascript" src="pdf.js/crypto.js"> </script>
    <script type="text/javascript" src="pdf.js/evaluator.js"> </script>
    <script type="text/javascript" src="pdf.js/fonts.js"> </script>
    <script type="text/javascript" src="pdf.js/glyphlist.js"> </script>
    <script type="text/javascript" src="pdf.js/image.js"> </script>
    <script type="text/javascript" src="pdf.js/metrics.js"> </script>
    <script type="text/javascript" src="pdf.js/parser.js"> </script>
    <script type="text/javascript" src="pdf.js/pattern.js"> </script>
    <script type="text/javascript" src="pdf.js/stream.js"> </script>
    <script type="text/javascript" src="pdf.js/worker.js"> </script>
    <script type="text/javascript" src="pdf.js/jpg.js"> </script>
    <script type="text/javascript" src="pdf.js/jpx.js"> </script>
    <script type="text/javascript" src="pdf.js/jbig2.js"> </script>
    <script type="text/javascript" src="pdf.js/bidi.js"> </script>
    <script type="text/javascript">
        var docUrl = document.URL,
            url = docUrl.substring(docUrl.lastIndexOf("=") + 1, docUrl.length),
            THEFILEPATH = url;
        PDFJS.workerSrc = "pdf.js/worker_loader.js";
    </script>
    <!--#if GENERIC || CHROME-->
    <!--#include viewer-snippet.html-->
    <!--#endif-->
    <script type="text/javascript" src="pdf.js/viewer.js"> </script>
    <script type="text/javascript" src="pdf.js/debugger.js"> </script>
</head>
<body>
            ...
            <div id="mainContainer">
                <div class="findbar hidden doorHanger" id="findbar">
                    ...
                    <div class="splitToolbarButton">
                        <button class="toolbarButton findPrevious" title="" id="findPrevious" tabindex="21"
                    ...
                    <label for="findHighlightAll" class="toolbarLabel" tabindex="23" data-l10n-id="find_highlight">
                        Highlight all</label>
                    <input type="checkbox" id="findMatchCase" class="toolbarField">
                    <label for="findMatchCase" class="toolbarLabel" tabindex="24" data-l10n-id="find_match_case_label">
                        Match case</label>
                    ...
                    <div id="toolbarContainer">
                        <div id="toolbarViewer">
                            ...
                            <div id="toolbarViewerRight">
                                ...
                                <button id="fullscreen" class="toolbarButton fullscreen" title="Switch to Presentation Mode"
                                    tabindex="11" data-l10n-id="presentation_mode">
                                ...
                                <a href="#" id="viewBookmark" class="toolbarButton bookmark" title="Current view (copy or open in new window)"
                                    tabindex="15" data-l10n-id="bookmark"><span data-l10n-id="bookmark_label">Current View</span></a>
                            </div>
