<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Cost_Replacement.aspx.cs" Inherits="SISMONUi.Security.Cost_Replacement" %>
                ...
                <div class="conten_caja_sub_categoria marhin-topnone" style="width: 940px;">
                    ...
                    <div class="tabla_sup_caja_sub_categoria" style="min-height: 350px;">
                        <telerik:radgrid id="rgList" groupingsettings-casesensitive="false" runat="server"
                            ...
                            <MasterTableView>
                                <Columns>
                                    <telerik:GridBoundColumn HeaderText="Keyword" UniqueName="Keyword" DataField="Keyword"
                                        FilterControlWidth="420px">
                                        <ItemStyle Width="420px" />
                                        <HeaderStyle Font-Bold="True" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn HeaderText="Costo Inicial" UniqueName="Cost" DataField="Cost">
                                        <ItemStyle />
                                        <HeaderStyle Font-Bold="True" />
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Edic." ItemStyle-Width="30px" AllowFiltering="false"
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imgEdit" ToolTip="Editar" runat="server" CommandName="Edicion"
                                                CommandArgument='<%# Eval("Keyword") %>' ImageUrl="~/img/Edit.png" />
                                        </ItemTemplate>
                                        <HeaderStyle Font-Bold="True" />
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Ver" ItemStyle-Width="30px" AllowFiltering="false"
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imgbVer" ToolTip="Ver Detalle" runat="server" CommandName="Ver"
                                                CommandArgument='<%# Eval("Keyword") %>' ImageUrl="~/img/view.png" />
                                        </ItemTemplate>
                                        <HeaderStyle Font-Bold="True" />
                                    </telerik:GridTemplateColumn>
                                </Columns>
